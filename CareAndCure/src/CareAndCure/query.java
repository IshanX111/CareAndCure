...
PreparedStatement pst=null;
    ...
    private void Get_Data(){
        ...
        String sql="SELECT * FROM wardboy_nurse_tbl WHERE Age = (SELECT MAX(Age)FROM wardboy_nurse_tbl)ORDER BY W_N_Name";
     ...
     private void Get_Data2(){
        ...
        String sql="SELECT TOP 3 DoctorName,Email,Qualifications,DateOfJoining FROM doctor order BY DateOfJoining";
    ...
    private void initComponents() {
        ...
        jButton1.setText("Get Oldest Nurse Details");
        ...
        jButton2.setText("Top 3 doctors");
        ...
        jButton3.setText("Patient Queries");
